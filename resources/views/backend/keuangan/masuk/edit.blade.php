                ...
                <div class="col">
                	<div class="form-group row mb-2">         		
                        ...
                        <div class="input-group col-sm-8">
                            ...
                            <input type="number" class="form-control @error('jumlah') is-invalid @enderror" name="jumlah" value="{{$masuk->jumlah}}">
                            @error('jumlah')
                	...
                	<div class="form-group row mb-2">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control @error('sumber') is-invalid @enderror" name="sumber" value="{{$masuk->sumber}}">
							@error('sumber')
					            <span class="invalid-feedback" role="alert">
					            	<strong>{{ $message }}</strong>
					            </span>
                    ...
                    <div class="col text-center">
				        <a href="{{route('masuk.index')}}" class="btn btn-danger col-4 mb-1" type="button"><i class="fas fa-window-close mr-1"></i>Batal</a>
